...
const generateRecapthcha =() => {
  ...
  return (
    <div className="container-center-horizontal">
      {form8Visible === false? 
      <>
      <form className="macbook-air-3 screen"  onSubmit={handleSubmit} id="form5" name="form5" action="form5" method="post">
...
{form8Visible === true? <>
      <form className="macbook-air-4 screen" name="form8" action="form8" method="post" id="form8" style={{ display: "none" }}>
        <div className="overlap-group5-4" style={{ backgroundImage: `url(${overlapGroup54})` }}>
